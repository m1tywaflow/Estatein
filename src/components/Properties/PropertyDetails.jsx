...
const PropertyDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white px-4 sm:px-6 lg:px-10 py-8 sm:py-10">
      <div className="max-w-7xl mx-auto">
        <Link
          to="/properties"
          className="text-purple-400 hover:underline mb-6 inline-block text-sm sm:text-base"
        >
          ← Back to all properties
        </Link>
        ...
        <div className="mb-10">
          ...
          {/* Main slider */}
          <div className="relative overflow-hidden rounded-2xl h-64 sm:h-80 md:h-[26rem] mb-6 bg-black">
            <div
              className="flex transition-transform duration-500 ease-in-out gap-0.5"
              style={{ transform: `translateX(-${activeIndex * 50}%)` }}
            >
              {gallery.map((img, idx) => (
                <img
                  ...
                  alt={`Slide ${idx}`}
                  onClick={() => openZoom(img)}
                  className="w-1/2 h-64 sm:h-80 md:h-[26rem] object-cover cursor-zoom-in"
                />
              ))}
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 pt-10">
          <div className="bg-black border border-zinc-800 text-white rounded-xl p-6 shadow-lg w-full lg:max-w-xl">
            ...
            <div className="border-t border-zinc-700 pt-4 flex text-sm text-zinc-400">
              ...
              <div className="flex-1 flex flex-col items-center gap-1">
                ...
                <div className="text-lg sm:text-xl">{property.beds}</div>
              </div>
              <div className="flex-1 flex flex-col items-center gap-1 border-l border-zinc-700">
                <div className="flex items-center gap-2">
                  <FaBath className="text-lg" />
                ...
                <div className="text-lg sm:text-xl">{property.baths}</div>
              </div>
              <div className="flex-1 flex flex-col items-center gap-1 border-l border-zinc-700">
                <div className="flex items-center gap-2">
                  <MdOutlinePriceCheck className="text-lg" />
                ...
                <div className="text-green-500 text-lg sm:text-xl font-semibold">
                  {property.price}
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-auto bg-black">
            <AmenitiesList />
          </div>
        </div>
      </div>
